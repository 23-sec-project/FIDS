...
# f_in1 = open('/Users/seungmin/PycharmProjects/FIDS/LSTM_result/Avante/Cybersecurity_Car_Hacking_Prediction_window10_slide10_avante.csv', 'r') #받은 데이터셋
# f_in2 = open('/Users/seungmin/PycharmProjects/FIDS/WhiteList/Avante_White_List_Window10.csv', 'r') #WhiteList
...
f_in2 = open('/Users/seungmin/PycharmProjects/FIDS/WhiteList/Soul_White_List_Window5.csv', 'r') #WhiteList
...
FPR = BFP / (BTN+BFP)
b = 1.5
F_beta_scroe = (1+ b*b) * (Precision * Recall) / ((b*b*Precision) + Recall)
...
print("보정 전 FPR : ", round(FPR*100,2))
print("보정 전 FNR : ", round(FNR*100,2))
print("보정 전 F1_beta_score : ", round(F_beta_scroe*100,2))
